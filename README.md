...
* If you'd like, you can create multiple "view" components for your routes. You could have a component whose sole purpose is to render the login form; one for a form for updating a user; another component who's sole purpose is for creating users; and then another component who's sole purpose is to delete a user.
